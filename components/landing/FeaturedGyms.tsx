...
const featuredGyms = [
  ...
  },
  {
    ...
    description: 'Professional training environment focused on strength and conditioning.',
  },
  {
    id: '3',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            Discover top-rated gyms in your area with premium facilities and expert trainers
          </p>
        </div>
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-2">
                  ...
                  <div className="flex items-center text-yellow-500">
                    ...
                    <span className="ml-1 text-sm text-gray-500">({gym.reviewCount})</span>
                  </div>
                </div>
